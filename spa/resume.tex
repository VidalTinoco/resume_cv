...
\begin{cventries}
    \cventry{Tribunal Electoral del Poder Judicial de la Federación (TEPJF)}{Científico de Datos Jr.}{Coyoacán, Ciudad de México}{Septiembre 2023 - Hoy}{\begin{cvitems}
...
\item R, RMarkdown, Python, SQL, Git/GitHub y Latex.
\end{cvitems}}
