...
tepjfds_2023$Details <- c("Científico de Datos Jr.", "Septiembre 2023 - Hoy", "Tribunal Electoral del Poder Judicial de la Federación (TEPJF)", "Coyoacán, Ciudad de México")
...
TechnicalSkills$Bullets <- c("R, RMarkdown, Python, SQL, Git/GitHub y Latex.")
