...
tepjfds_2023$Bullets <- c(
  "Extracción de datos mediante consultas SQL al Sistema de Información de la Secretaría General de Acuerdos (SISGA), para dar respuesta a solicitudes de información hechas vía el Portal Nacional de Transparencia.",
