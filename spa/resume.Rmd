...
tepjfds_2023$Details <- c("Científico de Datos Jr.", "Septiembre 2023 - Hoy", "Tribunal Electoral del Poder Judicial de la Federación", "Coyoacán, Ciudad de México")
tepjfds_2023$Bullets <- c(
  "A cargo de la creación de una ShinyApp para facilitar la extracción de datos mediante consultas SQL al Sistema de Información de la Secretaría General de Acuerdos (SISGA), para dar respuesta a solicitudes de información hechas vía el Portal Nacional de Transparencia.",
  "Creación de paquetes de R para la sistematización y presentación de los datos extraídos del SISGA.",
